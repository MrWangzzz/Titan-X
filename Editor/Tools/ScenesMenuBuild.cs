...
namespace TitanX
{
    ...
    public static class ScenesMenuBuild
    {
        ...
        static readonly string ScenesMenuPath = "Titan X/Editor/Scene/ScenesMenu.cs";

        [MenuItem("Scenes/Update This List")]
        public static void UpdateList()
        {
            string scenesMenuPath = Path.Combine(PathManger.GetPath, ScenesMenuPath);
            ...
            stringBuilder.AppendLine("namespace TitanX");
            ...
            stringBuilder.AppendLine("}");
            stringBuilder.AppendLine("}");
            DebugEX.LogError(Path.GetDirectoryName(scenesMenuPath) + ">>>>>>>****");
